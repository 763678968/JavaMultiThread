...
//    }
//
//    public MultithreadedStatTask(int sampleInterval, int traceIdDiff, String expectedOperationName, String expectedExternalDeviceList, InputStream in) {
//        super(sampleInterval, traceIdDiff, expectedOperationName, expectedExternalDeviceList);
//        this.in = in;
//    }
//
//    @Override
//    protected void doCaculate() throws IOException, InterruptedException {
